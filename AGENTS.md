...
This repository is **BRAINIAC AI v1.1.0** — a standalone Python FastAPI monolith. It is **not** tied to any other GitHub repository or legacy monorepo. All ten core modules and the Watchdog supervisor run in-process inside a single uvicorn server.
